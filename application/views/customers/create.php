        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control <?= form_error('email') ? 'is-invalid' : '' ?>" id="email" placeholder="Enter email">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="phone" class="form-control <?= form_error('phone') ? 'is-invalid' : '' ?>" id="phone" placeholder="Enter phone">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="address" class="form-control <?= form_error('address') ? 'is-invalid' : '' ?>" id="address" placeholder="Enter address">
