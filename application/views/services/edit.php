...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input value="<?= $service->name ?>" type="text" name="name" class="form-control <?= form_error('name') ? 'is-invalid' : '' ?>" id="name" placeholder="Enter name">
        ...
        <div class="form-group">
            ...
            <textarea name="short_desc" class="form-control <?= form_error('short_desc') ? 'is-invalid' : '' ?>" id="short_desc" placeholder="Enter a short description">
                <?= $service->short_desc ?>
            </textarea>
        ...
        <div class="form-group">
            ...
            <textarea id="summernote" name="details" class="form-control <?= form_error('details') ? 'is-invalid' : '' ?>">
                <?= $service->details ?>
            </textarea>
